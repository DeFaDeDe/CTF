...
![image.png](Deployment%20Detective/image.png)
...
![image.png](Deployment%20Detective/image%201.png)
...
![image.png](Deployment%20Detective/image%202.png)
...
1. Most tools convert the UNIX timestamp to UTC first(https://www.epochconverter.com/)
    ...
    ![image.png](Deployment%20Detective/image%203.png)
